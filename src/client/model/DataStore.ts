...
export class DataStore
{
  ...
  {
    ArrayUtils.pushIfMissing(this._tracks, track);
    ArrayUtils.pushIfMissing(this._albums, album);
    ...
    artists.forEach((artist: Artist) => {
      ArrayUtils.pushIfMissing(this._artists, artist);
    });

    genres.forEach((genre: Genre) => {
      ArrayUtils.pushIfMissing(this._genres, genre);
    });
